part of 'update_hospital_visit_schedules_cubit.dart';

class UpdateHospitalVisitSchedulesState extends Equatable {
  const UpdateHospitalVisitSchedulesState({
  ...
  UpdateHospitalVisitSchedulesState copyWith({
    FormzStatus? status,
