...
import 'package:yak/presentation/fibrosis_circulator/fibrosis_circulator_cubit.dart';
                ...
                children: [
                  _InformationBox(
                    ...
                    urls: List<String>.generate(
                      13,
                      (index) =>
                          'https://terms.naver.com/entry.naver?docId=26855${index + 5 >= 10 ? index + 5 : (index + 5).toString().padLeft(2, '0')}&categoryId=55588&cid=55588',
                    ),
                  ),
                  const SizedBox(height: 16),
                  _InformationBox(
                ...
                children: [
                  _InformationBox(
                    ...
                    urls: List<String>.generate(
                      12,
                      (index) =>
                          'https://terms.naver.com/entry.naver?docId=27042${index + 86}&categoryId=55588&cid=55588',
                    ),
                  ),
                  const SizedBox(height: 16),
                  _InformationBox(
